...
interface AnnualIncomeNewRecordProps {
  open: boolean;
...
export default function AnnualIncomeNewRecord({
  open,
  onOpenChange,
  onSuccess,
}: AnnualIncomeNewRecordProps) {
  // File upload state
  ...
  const handleSubmit = async () => {
    ...
    if (!fromDate) {
      setErrorMessage("Please enter from date.");
      return;
    }

    if (!toDate) {
      setErrorMessage("Please enter to date.");
      return;
    }
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="w-[90vw] max-w-4xl max-h-[90vh] overflow-y-auto custom-scrollbar">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <FileText className="h-5 w-5 text-primary" />
            New AI Statement Record
          </DialogTitle>
          <DialogDescription>
            Upload a PDF AI statement and fill in the details
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            <Label className="text-base font-semibold">PDF Upload</Label>
          ...
          {/* Form Fields */}
          <div className="space-y-4">
            <Label className="text-base font-semibold">Statement Details</Label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="investigator"
                  placeholder="Enter investigator officer name (optional)"
