...
interface BankStatementNewRecordProps {
  open: boolean;
...
export default function BankStatementNewRecord({
  open,
  onOpenChange,
  onSuccess,
}: BankStatementNewRecordProps) {
  // File upload state
      ...
      <DialogContent className="w-[90vw] max-w-4xl max-h-[90vh] overflow-y-auto custom-scrollbar">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            New Bank Statement Record
          </DialogTitle>
          <DialogDescription>
            Upload a PDF bank statement and fill in the details
          </DialogDescription>
        </DialogHeader>
